        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-center text-[#AAAACC] text-sm space-y-1">
              ...
              <p>대표자명 : 이주경 | 사업자번호 : 642-87-04062</p>
              <p>고객지원: <a href="mailto:pingme.support@gmail.com" className="text-[#FF2D78] hover:underline">pingme.support@gmail.com</a> | 문의처 : 0507-1355-5617</p>
            </div>
